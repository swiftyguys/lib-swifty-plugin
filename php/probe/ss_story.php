...
class SSStory
{
    ...
    function GetOurTestPath()
    {
        return $this->truepath( getcwd(). '/../../../../../test' );
    }
    ...
    function SetupProbeDescription()
    {
        ...
        $path = $this->GetOurTestPath();

        if( file_exists( $path . '/test.desc' ) ) {
            $handle = fopen( $path . '/test.desc', "r" );
//        } else {
//            $handle = fopen( $path . '/../../../../../../../test/test.desc', "r" );
        }
        if( $handle ) {
